...
public class playerBlueOFparticle : MonoBehaviour
{
  ...
  void OnParticleCollision(GameObject obj)
  {
    ...
    void Start()
    {
      normalPower = PlayerPrefs.GetInt("BlueOffenceATK", 50);
      ...
      main.duration = PlayerPrefs.GetInt("BlueOffenceITV", 50) * 0.1f;
      ps.Play();
    }
