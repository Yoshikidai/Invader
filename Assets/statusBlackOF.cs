...
public class statusBlackOF : MonoBehaviour
{
  ...
  int Point3;
    ...
    void Update()
    {
      HitPoint1 = CryptoPlayerPrefs.GetInt ("blackOFHitPoint", 300);
      Attack1 = CryptoPlayerPrefs.GetInt ("blackOFAttack", 300);
      Interval1 = CryptoPlayerPrefs.GetInt ("blackOFInterval", 300);
      ...
      Point1 = CryptoPlayerPrefs.GetInt ("blackOFpoint1", 50);
      Point2 = CryptoPlayerPrefs.GetInt ("blackOFpoint2", 50);
      Point3 = CryptoPlayerPrefs.GetInt ("blackOFpoint3", 50);
