...
public class playerRedBox : MonoBehaviour,IDragHandler
{
  ...
  public void OnDrag(PointerEventData data){
    ...
    if (TargetPos.x < -1.5f)
    {
      ...
      if (playerYellowBox.transform.position == new Vector3(-2f,-3.5f,-1f))
      {
        playerYellowBox.transform.position = transform.position;
      }
      else if (playerBlueBox.transform.position == new Vector3(-2f,-3.5f,-1f))
      {
    ...
    else if (TargetPos.x < -0.5f)
    {
      ...
      if (playerYellowBox.transform.position == new Vector3(-1f,-3.5f,-1f))
      {
        playerYellowBox.transform.position = transform.position;
      }
      else if (playerBlueBox.transform.position == new Vector3(-1f,-3.5f,-1f))
      {
        playerBlueBox.transform.position = transform.position;
      }
    ...
    {
      if (playerYellowBox.transform.position == new Vector3(0f,-3.5f,-1f))
      {
        playerYellowBox.transform.position = transform.position;
      }
      else if (playerBlueBox.transform.position == new Vector3(0f,-3.5f,-1f))
      {
        playerBlueBox.transform.position = transform.position;
      }
