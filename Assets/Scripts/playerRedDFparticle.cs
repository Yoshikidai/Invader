...
public class playerRedDFparticle : MonoBehaviour
{
  ...
  void OnParticleCollision(GameObject obj)
  {
    ...
    void Start()
    {
      normalPower = PlayerPrefs.GetInt("RedDefenceATK", 300);
      ...
      main.duration = PlayerPrefs.GetInt("RedDefenceITV", 300) * 0.01f;
      ps.Play();
    }
