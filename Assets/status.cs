...
public class status : MonoBehaviour
{
  ...
  int Point3;
    ...
    void Update()
    {
      HitPoint1 = CryptoPlayerPrefs.GetInt ("whiteDFHitPoint", 300);
      Attack1 = CryptoPlayerPrefs.GetInt ("whiteDFAttack", 300);
      Interval1 = CryptoPlayerPrefs.GetInt ("whiteDFInterval", 300);

      HitPoint2 = Mathf.FloorToInt(HitPoint1 * 1.1f);
      Attack2 = Mathf.RoundToInt(Attack1 * 1.05f);
      Interval2 = Mathf.RoundToInt(Interval1 * 0.95f);
      ...
      Point1 = CryptoPlayerPrefs.GetInt ("whiteDFpoint1", 50);
      Point2 = CryptoPlayerPrefs.GetInt ("whiteDFpoint2", 50);
      Point3 = CryptoPlayerPrefs.GetInt ("whiteDFpoint3", 50);
