...
public class statusRedOF : MonoBehaviour
{
  ...
  int Point3;
    ...
    void Update()
    {
      HitPoint1 = CryptoPlayerPrefs.GetInt ("redOFHitPoint", 300);
      Attack1 = CryptoPlayerPrefs.GetInt ("redOFAttack", 300);
      Interval1 = CryptoPlayerPrefs.GetInt ("redOFInterval", 300);
      ...
      Point1 = CryptoPlayerPrefs.GetInt ("redOFpoint1", 50);
      Point2 = CryptoPlayerPrefs.GetInt ("redOFpoint2", 50);
      Point3 = CryptoPlayerPrefs.GetInt ("redOFpoint3", 50);
